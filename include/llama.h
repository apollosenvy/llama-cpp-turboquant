...
extern "C" {
    ...
    enum llama_ftype {
        ...
        // FORK RESERVATION: ftypes 90-99 reserved for TurboQuant weight types
        // (moved from 43/44 in the 2026-08-15 sync; serialized general.file_type
        // in pre-sync TQ ggufs is stale and those files must be regenerated)
        LLAMA_FTYPE_MOSTLY_TQ3_1S        = 90, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TQ4_1S        = 91, // except 1d tensors
