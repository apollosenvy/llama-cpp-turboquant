...
class GGMLQuantizationType(IntEnum):
    ...
    Q1_0    = 41
    Q2_0    = 42
    # FORK RESERVATION: 90-99 turbo types (renumbered from 42-46 in 2026-08-15 sync)
    TURBO2_0 = 90
    TURBO3_0 = 91
    TURBO4_0 = 92
    TQ3_1S  = 93
...
class LlamaFileType(IntEnum):
    ...
    MOSTLY_TQ3_1S        = 90  # except 1d tensors (fork reserved band)
    MOSTLY_TQ4_1S        = 91  # except 1d tensors (fork reserved band)
