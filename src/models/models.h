...
struct llama_model_instella_moe : public llama_model_deepseek2 {
    llama_model_instella_moe(const struct llama_model_params & params) : llama_model_deepseek2(params) {}
    // fork: reuses deepseek2 hparams; tensors add the learned attention gate
