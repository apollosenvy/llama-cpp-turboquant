...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        GGML_TYPE_Q2_0    = 42,
        // FORK RESERVATION (2026-08-15 sync): slots 90-99 are reserved for
        // TurboQuant types so upstream may grow 43..89 without ever colliding
        // again. This renumber (was 42-46) breaks pre-sync serialized
        // turbo-WEIGHT ggufs, which must be regenerated; turbo KV-cache types
        // never serialize. Do not move these back down.
        GGML_TYPE_TURBO2_0 = 90, // TurboQuant 2-bit KV cache: WHT + 2-bit PolarQuant
        GGML_TYPE_TURBO3_0 = 91, // TurboQuant 3-bit KV cache: WHT + 3-bit PolarQuant
        GGML_TYPE_TURBO4_0 = 92, // TurboQuant 4-bit KV cache: WHT + 4-bit PolarQuant
        GGML_TYPE_TQ3_1S  = 93, // TurboQuant 3-bit weight: WHT-rotated 8-level Lloyd-Max, block_size=32
        GGML_TYPE_TQ4_1S  = 94, // TurboQuant 4-bit weight: WHT-rotated 16-level Lloyd-Max, block_size=32
        GGML_TYPE_COUNT   = 95,
    };
